...
def check2_3(probability_of_false, mode=CHECK):
...
def check2_5(approximate_probability_of_false, mode=CHECK):
...
def check3_2(landing_test_statistic, mode=CHECK):
...
def check3_4(p_value_difference, mode=CHECK):
    check_multiple_choice_in_bounds(p_value_difference, 2, mode)
